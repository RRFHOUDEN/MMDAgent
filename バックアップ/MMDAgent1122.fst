...
1    31   KEY|4         		      IMAGE_ADD|mei|image\mac.png|100.0,100.0|0.0,10.0,-10.0|0.0,0.0,0.0|ON
...
225  226   VALUE_EVENT_EVAL|z|LE|1|FALSE       IMAGE_ADD|mac|image\mac.png|5.0,5.0|5.0,20.0,-10.0|0.0,0.0,0.0|ON
226  230   <eps>			       SYNTH_START|mei|mei_voice_normal|たしかキャンパスの近くにマクドナルドがあったはずだわ。たしかこのあたりよ。すこしなにかたべて、お友達と宿題の話でもしましょうよ
...
# 0401-0450 aruaru
1    401   RECOG_EVENT_STOP|あるある            VALUE_SET|x||0|30
1    401   RECOG_EVENT_STOP|ある                VALUE_SET|x||0|30
401  402   VALUE_EVENT_SET|x                    VALUE_EVAL|x|LE|1
402  450    VALUE_EVENT_EVAL|x|LE|1|TRUE        SYNTH_START|mei|mei_voice_bashful|いっこめ。
402  403   VALUE_EVENT_EVAL|x|LE|1|FALSE        VALUE_EVAL|x|LE|2
403  450    VALUE_EVENT_EVAL|x|LE|2|TRUE        SYNTH_START|mei|mei_voice_bashful|にこめ。
403  404   VALUE_EVENT_EVAL|x|LE|2|FALSE        VALUE_EVAL|x|LE|3
404  450   VALUE_EVENT_EVAL|x|LE|3|TRUE         SYNTH_START|mei|mei_voice_bashful|さんこめ。
404  405   VALUE_EVENT_EVAL|x|LE|3|FALSE        VALUE_EVAL|x|LE|4
405  450   VALUE_EVENT_EVAL|x|LE|4|TRUE         SYNTH_START|mei|mei_voice_bashful|よんこめ。
