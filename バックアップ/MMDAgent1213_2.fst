...
11   12   MODEL_EVENT_ADD|bootscreen          MODEL_ADD|mei|Model\2018_c2_3dmodel\TMUboyv110.pmd|0.0,0.0,-14.0
...
141  142   MODEL_EVENT_DELETE|menu             SYNTH_START|mei|mei_voice_normal|質問をはじめるよお。それじゃあ、今のあなたの気分でのおすすめの暇つぶしスポットを教えちゃうよ！今から私がする質問に、はいかいいえで答えてね！じゃあはじめるよ！
142  143   SYNTH_EVENT_STOP|mei	               MODEL_ADD|yes|Accessory\yes_no\yes.pmd|-10,13,0
143  144   <eps>                               MODEL_ADD|no|Accessory\yes_no\no.pmd|9,13,0
144  145   <eps>             		       SYNTH_START|mei|mei_voice_normal|質問1、今日はちゃんと朝ごはんを食べてきましたか？ 
145  150   RECOG_EVENT_STOP|はい	       VALUE_SET|x|1
145  150   KEY|1			       VALUE_SET|x|1
145  150   RECOG_EVENT_STOP|の             　　VALUE_SET|x|0
145  150   KEY|2			       VALUE_SET|x|0			       
...
201  207   VALUE_EVENT_EVAL|z|EQ|0|TRUE        SYNTH_START|mei|mei_voice_normal|ゼットは０点です。
201  203   VALUE_EVENT_EVAL|z|EQ|0|FALSE       VALUE_EVAL|z|EQ|1
203  207   VALUE_EVENT_EVAL|z|EQ|1|TRUE        SYNTH_START|mei|mei_voice_normal|ゼットは１点です。
203  205   VALUE_EVENT_EVAL|z|EQ|1|FALSE       VALUE_EVAL|z|EQ|2
205  207   VALUE_EVENT_EVAL|z|EQ|2|TRUE        SYNTH_START|mei|mei_voice_normal|ゼットは２点です。
205  206   VALUE_EVENT_EVAL|z|EQ|2|FALSE       VALUE_EVAL|z|EQ|3
206  207   VALUE_EVENT_EVAL|z|EQ|3|TRUE        SYNTH_START|mei|mei_voice_normal|ゼットは３点です。

207 208    SYNTH_EVENT_STOP|mei                MODEL_DELETE|yes
208 210    <eps>                               MODEL_DELETE|no

210  211   MODEL_EVENT_DELETE|no               VALUE_EVAL|x|GE|2
...
230  231   SYNTH_EVENT_STOP|mei                MODEL_ADD|menu|Accessory\menu\menu.pmd|0.0,-4.5,0.0|0.0,0.0,0.0|mei
231    2   MODEL_EVENT_ADD|menu                MOTION_ADD|menu|rotate|Motion\menu_rotation\menu_rotation.vmd|FULL|LOOP|OFF
...
#weather information
1    1001  KEY|a                             <eps>
1001 1002 RECOG_EVENT_STOP|今日               SYNTH_START|mei|mei_voice_normal|今日の天気は晴時々曇です。
...
601  602  RECOG_EVENT_STOP|はい               SYNTH_START|mei|mei_voice_normal|【お知らせ@学生広報チーム】大学ホームページでは体育会系の学生の活躍を多くお伝えしていますが、文化部の活動にも目が離せません！今週末には本学唯一の混声合唱団、エリカ混声合唱団の演奏会が行われます。入学式や卒業式でも本学校歌を演… https://t.co/d1G93IivES
